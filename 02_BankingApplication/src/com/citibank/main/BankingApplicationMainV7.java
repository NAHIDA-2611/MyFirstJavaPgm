...
public class BankingApplicationMainV7 {
 ...
 //        public static Account getAccountByChoice (int choic)  {
 //           if (choice == 1)   {
 //          System.out.println("Do you want to .........");
        ...
        {    System.out.print("Do you want to open Salary account(Yes/No)?  ");
            ...
            account = new SavingsAccount(accountNumber,name,balance,isSalary);
            ...
            System.out.println("Salary account (true/false): " + ((SavingsAccount) account).isSalary());
        }
